...
export default function HospitalOverviewStrip({ requests = [] }) {
  ...
  // Reorder array so semantic mapping matches visual clustering (Active is focal)
        ...
        {cards.map((card) => {
          ...
          return (
            ...
            >
              ...
              >
                {/* Backplate Tab */}
                <div className={`absolute inset-x-0 -bottom-2.5 top-6 rounded-[20px] ${card.backplateBg} transition-all duration-300 shadow-sm lg:group-hover:translate-y-1 lg:group-hover:shadow-md`}></div>
                ...
                <div className={`relative bg-white/95 backdrop-blur-sm border ${card.isFocal ? 'border-brand-red/20' : 'border-slate-100'} rounded-[20px] p-5 shadow-[0_4px_15px_rgb(0,0,0,0.05)] flex flex-col justify-between h-[130px] lg:h-[140px]`}>
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-black text-brand-navy tracking-tight leading-none mb-3">
